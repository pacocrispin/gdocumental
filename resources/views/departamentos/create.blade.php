@extends('layouts.main',['activePage' => 'departamentos','titlePage' => 'Nuevo Departamento'])
@section('content')
    <div class="content">
                    ...
                    <form action="{{ route('departamentos.store')}}" method="post" class="form-horizontal">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <label for="nombre" class="col-sm-2 col-form-label">Nombre de Departamento</label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="nombre" placeholder="Ingrese el Nombre del Departamento" value="{{old('nombre')}}">
